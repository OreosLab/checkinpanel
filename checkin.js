...
$exec(`python3 https://raw.githubusercontent.com/Oreomeow/checkinpanel/master/${pyname}`, {
    ...
    env: {
        ...
        TG_USER_ID: $store.get('TG_USER_ID', 'string'),                           // tg机器人的 TG_USER_ID；secrets 可填
        ...
        QQ_SKEY: $store.get('QQ_SKEY', 'string'),                                 // qq 机器人的 QQ_SKEY；secrets 可填
        QQ_MODE: $store.get('QQ_MODE', 'string'),                                 // qq 机器人的 QQ_MODE；secrets 可填
