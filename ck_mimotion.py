...
class MiMotion:
    def __init__(self, mimotion_account_list):
        self.mimotion_account_list = mimotion_account_list
    ...
    def main(self):
        for mimotion_account in self.mimotion_account_list:
            ...
            try:
                min_step = int(self.mimotion_account.get("mimotion_min_step", 10000))
            except Exception as e:
                print("初始化步数失败: 已将最小值设置为 19999", e)
                min_step = 10000
            try:
                max_step = int(self.mimotion_account.get("mimotion_max_step", 19999))
            except Exception as e:
